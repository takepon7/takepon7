...
- **面談記録型のB2B SaaS**(開発中)— 業界特化のAI議事録。Next.js + Clerk + Supabase + DDD
  → **[事例紹介](https://github.com/takepon7/claude-code-ddd-case-study)**(Claude Code + DDD のベストプラクティス) / **[Zenn記事](https://zenn.dev/takepon7/articles/3dd56bd4c46304)**
...
- 🔗 ライブデモ: [kaigo-dx](https://kaigo-dx.vercel.app/)
